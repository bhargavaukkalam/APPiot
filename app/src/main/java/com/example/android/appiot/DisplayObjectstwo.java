...
public class DisplayObjectstwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        setContentView(R.layout.activity_display_objectstwo);
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
       ...
       textView = (TextView) findViewById(R.id.fetcheddata);
        ...
        String[] Objects ={
                ...
                "                                                    Status",
                "Frey Hall 101 - Fan                         ON",
                "Frey Hall 101 - Light                      ON",
                "Frey Hall 201 - Printer                  OFF",
    ...
    public void onBack(View view) {
        if (view.getId() == R.id.onBack ) {
            ...
            finish();
            Intent i = new Intent(getApplicationContext(), HomeScreentwo.class);
            startActivity(i);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case logout:
                finish();
                Intent i = new Intent(DisplayObjectstwo.this, ProfileActivitytwo.class);
                startActivity(i);
                return true;
            default:
